...
//        hdrToCubemapShader = std::make_unique<OpenGLShader>("Assets/shaders/Skybox/hdr_to_cubemap.shader");
...
//
//        
//        irradianceMapShader = std::make_unique<OpenGLShader>("Assets/Shaders/Skybox/irradiance_skybox.shader");
...
//        glGenerateMipmap(GL_TEXTURE_CUBE_MAP);
//
//        prefilterShader = std::make_unique<OpenGLShader>("Assets/Shaders/Skybox/prefilter.shader");
...
//        
//        brdfShader = std::make_unique<OpenGLShader>("Assets/Shaders/Skybox/brdf.shader");
//        brdfShader->Bind();
//        glViewport(0, 0, 512, 512);
//        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
//        DrawQuad();
...
//
//
//        skyboxShader = std::make_unique<OpenGLShader>("Assets/Shaders/Skybox/skybox.shader");
//
//        reflectionLod = 2.0f;
...
//        };
//
//        cubeVao = std::make_unique<OpenGLVertexArray>();
//        cubeVbo = std::make_unique<OpenGLVertexBuffer>(vertices, 108);
...
//        };
//
//        quadVao = std::make_unique<OpenGLVertexArray>();
//        quadVbo = std::make_unique<OpenGLVertexBuffer>(vertices, 20);
